# Generated by Django 2.1.1 on 2018-11-26 15:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inspinia', '0003_inspiniatreeitem_show_icon_on_page'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Parent site tree item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='treeitem_parent', to='sitetree.TreeItem', verbose_name='Parent')),
                ('tree', models.ForeignKey(help_text='Site tree this item belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='treeitem_tree', to='inspinia.InspiniaTree', verbose_name='Site Tree')),
            ],
            options={
